  ...
  return (
    <section className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <p className="font-style text-3xl text-color-medium mb-4">Welcome To Tourm</p>
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            Leiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-color-darkest mb-1">Exclusive Trip</h4>
                <p className="text-gray-600 text-sm">There are many variations of passages of available but the majority.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-color-darkest mb-1">Safety First Always</h4>
                <p className="text-gray-600 text-sm">There are many variations of passages of available but the majority.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-color-darkest mb-1">Professional Guide</h4>
                <p className="text-gray-600 text-sm">There are many variations of passages of available but the majority.</p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-color-lightest py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h1 className="font-style text-3xl text-color-medium mb-4">Services we Offer</h1>
            <h2 className="text-2xl md:text-3xl text-color-medium font-medium">Our Amazing services</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { 
                image: "src/assets/img/1f008394f3aadd458ff475a04c470d9c_upscayl_3x_upscayl-standard-4x.webp", 
                title: "Photo Shoot", 
                listings: "20 Lining" 
              },
              { 
              ...
              <div key={idx} className="bg-[#E9F6F9] rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <div className="p-6 text-center">
                  <h3 className="text-lg font-semibold text-color-darkest mb-2">{service.title}</h3>
...
<div className="bg-white py-16">
  <div className="max-w-7xl mx-auto px-6">
    <div className="text-center mb-16">
      <h1 className="font-style text-3xl text-color-medium mb-4">Meet with Guide</h1>
      <h2 className="text-2xl md:text-3xl text-color-medium font-medium">Meet with Tour Guide</h2>
    </div>
    ...
    <div className="flex justify-center items-center space-x-8">
      {[
        {
          name: "Michel Smith",
          role: "Tourist Guide",
          profileImg: "src/assets/img/1f008394f3aadd458ff475a04c470d9c_upscayl_3x_upscayl-standard-4x.webp",
          backgroundImg: "src/assets/img/1f008394f3aadd458ff475a04c470d9c_upscayl_3x_upscayl-standard-4x.webp",
          social: {
            facebook: "#",
            twitter: "#", 
            instagram: "#",
        ...
        <div key={idx} className="flex-shrink-0 w-80">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
            ...
            <div className="pt-16 pb-6 px-6">
              <h3 className="text-xl font-bold text-color-darkest mb-2">{guide.name}</h3>
              <p className="text-color-medium font-semibold mb-6">Tourist Guide</p>
      ...
      <div className="bg-color-lightest py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h1 className="font-style text-4xl text-color-darkest mb-4">Testimonials</h1>
            <h2 className="text-2xl text-color-medium">What Clients Say About Us</h2>
          </div>

          <div className="flex overflow-x-auto scrollbar-hide space-x-6 pb-8">
            {[
              { name: "Maria Doe", text: "A home that perfectly blends sustainability with luxury. The commitment to eco-friendly living is amazing." },
              { name: "Alex Jordan", text: "Solar panels and high-performance insulation make this place energy efficient and comfortable." },
              { name: "Andrew Simon", text: "The home boasts sleek, contemporary architecture with clean lines and expansive windows." },
              { name: "Sarah Wilson", text: "Exceptional service and attention to detail. Can't wait to book our next adventure!" },
            ].map((testimonial, idx) => (
              <div key={idx} className="flex-shrink-0 w-80">
                <div className="card-hover transition-smooth bg-white rounded-2xl shadow-lg p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-color-darkest">{testimonial.name}</h3>
          ...
          <div className="mb-16">
            <h3 className="text-3xl font-bold text-color-darkest text-center mb-8">Our Travel Memories</h3>
